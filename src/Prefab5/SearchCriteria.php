...
namespace Neighborhoods\SearchCriteriaValidatorComponent\Prefab5;

use Neighborhoods\SearchCriteriaValidatorComponent\Prefab5\SearchCriteria\FilterInterface;
use Neighborhoods\SearchCriteriaValidatorComponent\Prefab5\SearchCriteria\SortOrder;
use Neighborhoods\SearchCriteriaValidatorComponent\Prefab5\SearchCriteria\Filter;
use Neighborhoods\SearchCriteriaValidatorComponent\Prefab5\SearchCriteria\Visitor;
...
use Neighborhoods\SearchCriteriaValidatorComponent\Prefab5\SearchCriteria\Doctrine\DBAL\Query\QueryBuilder;
use Neighborhoods\SearchCriteriaValidatorComponent\ValidatorVisitor; /** @override */
...
class SearchCriteria implements SearchCriteriaInterface
{
    ...
    use ValidatorVisitor\Factory\AwareTrait; /** @override */
